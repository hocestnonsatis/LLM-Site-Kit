...
- [ ] **MCP & search index** — If you changed the MCP server or search index, you verified `list_documentation_pages`, `read_documentation_page`, and (when enabled) `search_documentation` still work (e.g. via `npx llm-site-mcp` and an MCP client).
